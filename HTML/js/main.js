...
function pieChart() {
	...
	if ((jQuery().easyPieChart) && (jQuery.support.leadingWhitespace)) {
		var count = 0 ;
		var colors = ['#77a03f', '#bd2029', '#e55225', '#3e642f'];
...
jQuery(document).ready(function() {
	...
	//parallax
	if (jQuery().parallax) {
		jQuery('#section1').parallax("50%", 0.2);
		jQuery('#classes').parallax("50%", 0.05);
		jQuery('#buy').parallax("50%", 0.05);
		jQuery('#testimonials').parallax("50%", 0.05);		
		jQuery('#fun_factor').parallax("50%", 0.05);
		jQuery('#contact').parallax("50%", 0.05);
		jQuery('#breadcrumbs').parallax("50%", 0.05);
...
jQuery(window).load(function(){
	...
	jQuery(affixHeader).on('affix-top.bs.affix', function () {
		if (jQuery(this).hasClass('animating')) {
			...
			jQuery(this).toggleClass('animating').animate({opacity:0}, 10).delay(100).animate({opacity:1, top: 50}, 500).queue(function(){
				jQuery(this).toggleClass('animating');
				jQuery(this).dequeue();
			});
		}
...
jQuery(window).load(function(){
        ...
        //Comment to not display switcher
